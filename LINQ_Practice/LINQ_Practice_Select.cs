...
namespace LINQ_Practice
{
     ...
     */
    {
        ...
        {
            var expected = PracticeData.Select(cohorts => cohorts.PrimaryInstructor).ToList();
        ...
        {
            var expected = PracticeData.SelectMany(cohorts => cohorts.Students).ToList();
        ...
        {
            var expected = PracticeData.Select(cohorts => cohorts.PrimaryInstructor.FirstName).ToList();
