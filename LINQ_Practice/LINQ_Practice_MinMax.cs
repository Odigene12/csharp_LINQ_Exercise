...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var maxValue = PracticeData[2].Students.Max(age => age.Birthday.Date); //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var minValue = PracticeData[2].Students.Min(age => age.Birthday.Date); //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var maxValue = PracticeData.Max(inst => inst.JuniorInstructors.Count); 
