...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(cohorts => cohorts.JuniorInstructors.Count >= 2);
        ...
        {
            var doAll = PracticeData.All(cohorts => cohorts.PrimaryInstructor.Birthday.Year >= 1980 && cohorts.PrimaryInstructor.Birthday.Year < 1990);
        ...
        {
            var doAll = PracticeData.All(cohorts => cohorts.PrimaryInstructor.FirstName.Contains("a"));
