...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(cohort => cohort.JuniorInstructors.Count == 3);
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(cohort => cohort.JuniorInstructors.Count == 2);
